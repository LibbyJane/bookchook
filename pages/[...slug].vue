<template>
    <article class="container">
        ...
        <h3>H3 brochure layout</h3>
        <p>Repellat quas sit odit occaecati. Nostrum quo numquam et culpa deleniti. Sunt esse iure non maiores voluptas. Quas vero aut minus et in quis. Voluptas vel a repellendus quia corporis.</p>

        <h4>H4 brochure layout</h4>
        <p>Labore reprehenderit quaerat dolores excepturi quis a. Id tempora odio velit libero consequatur nobis ipsum. Sit libero officiis debitis qui facilis nulla velit. Ratione quis dolores labore ut possimus.</p>

        <h5>H5 brochure layout</h5>
        <p>Labore reprehenderit quaerat dolores excepturi quis a. Id tempora odio velit libero consequatur nobis ipsum. Sit libero officiis debitis qui facilis nulla velit. Ratione quis dolores labore ut possimus.</p>

        <h6>H6 brochure layout</h6>
        <p>Labore reprehenderit quaerat dolores excepturi quis a. Id tempora odio velit libero consequatur nobis ipsum. Sit libero officiis debitis qui facilis nulla velit. Ratione quis dolores labore ut possimus.</p>

        <p>Corrupti minima doloremque qui asperiores exercitationem. Aliquid neque delectus non recusandae. Voluptas temporibus et excepturi aliquam neque aut maxime quisquam.</p>
    </article>
</template>
