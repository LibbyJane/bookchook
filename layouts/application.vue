<template>
    ...
    <div class="main-outer" :style="`
        ...
        --c-header-text-hsl: ${ organisationStore.account.theme_config.colors.header_text.hsl.hsl ? organisationStore.account.theme_config.colors.header_text.hsl.hsl : '--c-accent-contrast-hsl'};
        --c-header-text: hsl(var(--c-header-text-hsl));

        --c-header-accent-hsl: ${ organisationStore.account.theme_config.colors.header_accent.hsl.hsl ? organisationStore.account.theme_config.colors.header_accent.hsl.hsl : '--c-accent-contrast-hsl'};
        ...
        --c-accent-contrast-hsl: ${organisationStore.account.theme_config.colors.accent_contrast.hsl.hsl ? organisationStore.account.theme_config.colors.accent_contrast.hsl.hsl : '--c-accent-contrast-hsl' };
